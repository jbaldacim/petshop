      ...
      <div className="container mx-auto px-4">
        <div className="mb-12">
          ...
          <div className="relative">
                    ...
                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                      <div className="flex-1 flex items-start justify-between">
                        <div className="flex gap-3">
                          <span className="text-3xl py-2.5">{item.icon}</span>
                          <div>
                      ...
                      <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                        ...
                        <a
                          href="#"
                          className="items-center flex justify-center gap-2 hover:bg-[#e84c3d] px-4 py-1 rounded-md duration-300"
                        >
            ...
            <button
              className="flex items-center justify-center rounded-full shadow-lg bg-white h-10 w-10 absolute left-2 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:bg-gray-100"
              onClick={scrollPrev}
            >
              <ChevronLeft className="w-6 h-6 text-gray-600" />
            </button>
            <button
              className="flex items-center justify-center rounded-full shadow-lg bg-white h-10 w-10 absolute -right-7.5 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:bg-gray-100"
              onClick={scrollNext}
            >
